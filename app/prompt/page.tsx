...
export default function Prompt() {
  ...
  function proceed() {
    ...
    if (stage1 == "arithmetic sequence") {
      if (stage2 == "sum") {
        if(answer){
        answer.innerHTML = Functions.findSumOfArithmeticSequence(sequence, n).toString();
        }
      } else if (stage2 == "nth") {
        if(answer){
        answer.innerHTML = Functions.findNthTermOfArithmeticSequence(sequence, n).toString();
        }
      } else {
        if(answer){
      ...
      if (stage2 == "circle") {
        if(answer){
        answer.innerHTML = Functions.findAreaOfCircle(radiusOrDiameter, value).toString();
        }
        ...
        if(answer){
        answer.innerHTML = Functions.findAreaOfRectangle(length, breadth).toString();
        }
      } else {
        if(answer){
        answer.innerHTML = "We're sorry, we are under development. So, we can't understand what you're asking about area.";
        }
      }
      ...
      if (stage2 == "circle") {
        if (radiusOrDiameter == "radius") {
          if(answer){
          answer.innerHTML = Functions.findPerimeterOfCircle("radius", value).toString();
          }
        } else if (radiusOrDiameter == "diameter") {
          if(answer){
          answer.innerHTML = Functions.findPerimeterOfCircle("diameter", value).toString();
          }
        } else {
          if(answer){
          answer.innerHTML =
        ...
        if(answer){
        answer.innerHTML = Functions.findPerimeterOfRectangle(length, breadth).toString();
        }
      } else {
        if(answer){
        answer.innerHTML =
      ...
      if (stage2 == "cylinder") {
        if(answer){
        answer.innerHTML = Functions.findVolumeOfCylinder(radius, height).toString();
        }

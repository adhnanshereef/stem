...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      type: "article",
      title: `Subshell Electronic Configuration of the element with atomic number ${atomicNumber}`,
      description: `${answer}`,
      images: ["/images/atom.jpg"],
    },
    twitter: {
      card: "summary",
      title: `Subshell Electronic Configuration of the element with atomic number ${atomicNumber}`,
...
export default function SubshellElectronicConfiguration({
  ...
  subshellelectronicConfiguration(atomicNumber);
